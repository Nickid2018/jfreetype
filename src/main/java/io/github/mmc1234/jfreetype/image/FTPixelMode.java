...
public enum FTPixelMode implements CEnum {
     ...
     * Note that the number of ‘gray’ levels is stored in {@link FTBitmap#NUM_GRAYS} structure (it generally is 256).
     */
    FT_PIXEL_MODE_GRAY,

    /**
     * A 2-bit per pixel bitmap, used to represent embedded anti-aliased bitmaps in font files according to
     * the OpenType specification. We haven't found a single font using this format, however.
     */
    FT_PIXEL_MODE_GRAY2,

    /**
     * A 4-bit per pixel bitmap, representing embedded anti-aliased bitmaps in font files according to
     * the OpenType specification. We haven't found a single font using this format, however.
     */
    FT_PIXEL_MODE_GRAY4,
     ...
     * the bitmap is three times wider than the original glyph image. See also
     * {@link io.github.mmc1234.jfreetype.core.FTRenderMode#FT_RENDER_MODE_LCD}.
     */
    FT_PIXEL_MODE_LCD,
     ...
     * {@link io.github.mmc1234.jfreetype.core.FTRenderMode#FT_RENDER_MODE_LCD_V}.
     */
    FT_PIXEL_MODE_LCD_V,

    /**
     * [Since 2.5] An image with four 8-bit channels per pixel, representing a color image (such as emoticons)
