...
public class RenderGlyphTest {
    ...
    public void main() throws IOException {
        ...
        System.out.println(VarUtils.getString(FTFace.FAMILY_NAME.handle(), face));
        ...
        MemorySegment slot = getSegment(FTFace.GLYPH.handle(), face, FTGlyphSlot.STRUCT_LAYOUT);
        ...
        MemorySegment bitmap = getSegment(FTBitmapGlyph.BITMAP.handle(), star(ptrGlyph, FTBitmapGlyph.STRUCT_LAYOUT), FTBitmap.STRUCT_LAYOUT);
        ...
        int pixelMode = FTBitmap.PIXEL_MODE.get(bitmap);
